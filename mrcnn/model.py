...
def load_image_gt(dataset, config, image_id, augment=False, augmentation=None,
                  use_mini_mask=False,aug_for_cls=None):
    ...
    aug_for_cls: If not None, provide a list containing class that should be augmentated.
    ...
    if augmentation:
        ...
        # TODO: <3> augmentation on the image
    ...
    _idx = np.logical_and(np.sum(mask, axis=(0, 1)) > 0,id_mask>0)
    mask = mask[:, :, _idx]
